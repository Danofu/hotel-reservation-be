...
export class firstMigration1671036105696 implements MigrationInterface {
    name = 'firstMigration1671036105696'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "menu" ("id" SERIAL NOT NULL, "nazwa" character varying NOT NULL, "kalorycznosc" integer NOT NULL, "cena" integer NOT NULL, CONSTRAINT "PK_35b2a8f47d153ff7a41860cceeb" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "kategorja" ("id" SERIAL NOT NULL, "kategorja" character varying NOT NULL, "ilosc_miejsc" integer NOT NULL, "ilosc_mieszkan" integer NOT NULL, "dodatkowa_informacja" character varying NOT NULL, "cena" integer NOT NULL, CONSTRAINT "PK_72d875601bfda42182bfca1d540" PRIMARY KEY ("id"))`);
